...
int main(int argc, char *argv[])
{
	...
	ok(0, "msg2"); expect(p[0], "not ok 2 - msg2\n#     Failed test (" __FILE__ ":main() at line " STR(__LINE__) ")\n");
	...
	todo_start("todo");
	ok1(false); expect(p[0], "not ok 9 - false # TODO todo\n#     Failed (TODO) test (" __FILE__ ":main() at line " STR(__LINE__) ")\n");
	ok1(true);
